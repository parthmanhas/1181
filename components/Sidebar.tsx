...
export default function Sidebar({ selectedItem, setSelectedItem }: { selectedItem: number, setSelectedItem: Dispatch<SetStateAction<number>> }) {
    return (
        <div className="p-5 border-r-2 border-gray-100">
            <Logo />
            <div className='mt-5'>
