    ...
    return (
        <main className="flex w-full">
            <div className="w-[60%] py-14 px-28 h-[100vh]">
                ...
                <h1 className="text-4xl font-semibold mt-10">YouTube video to <br></br> LinkedIn Post Generator</h1>
                <p className="mt-5 font-medium text-gray-500">Generate 2 unique SEO blog for your next viral video.</p>
                <form className="mt-10">
                    <div className="flex flex-col w-1/2">
                        <label className="font-medium text-gray-600 mb-1">Enter the youtube video link</label>
                        <input className="border-2 border-gray-300 rounded-md p-2" placeholder="https://youtu.be/"></input>
                    </div>
